function [a,b,Sigma_a,Sigma_b,Q,Cov_ab,r_ab,Chi2] = linear_fit (x,y,Sigma_y)
%
% [a,b,Sigma_a,Sigma_b,Q,Cov_ab,R_ab,Chi2] = linear_fit (x,y,Sigma_y)
%
% Given data points (x,y) with individual standard deviations, Sigma_y, 
% fits them to a straight line, 
%         y = a + b*x.
...
if (nargout==1)
  ...
  % for bootstrapping...)
  a = [a,b,Sigma_a,Sigma_b,Q,Cov_ab,r_ab,Chi2];
end
